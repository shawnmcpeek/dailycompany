...
class KempisCompanionPaywallScreen extends ConsumerStatefulWidget {
  const KempisCompanionPaywallScreen({super.key});

  @override
  ConsumerState<KempisCompanionPaywallScreen> createState() =>
      _KempisCompanionPaywallScreenState();
}

class _KempisCompanionPaywallScreenState
    extends ConsumerState<KempisCompanionPaywallScreen> {
  bool _busy = false;
